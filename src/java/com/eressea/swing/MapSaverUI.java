...
public class MapSaverUI extends InternationalizedDialog {
	private final static Logger log = Logger.getInstance(MapSaverUI.class);
	...
	private void btnSaveAction(java.awt.event.ActionEvent evt) {
		try {
			...
			javax.swing.JOptionPane.showMessageDialog(this,
				getString("msg.erroronsave.text") + ex.toString(), getString("msg.erroronsave.title"),
				javax.swing.JOptionPane.ERROR_MESSAGE);
		} 
		catch (OutOfMemoryError oomError) {
			log.error(oomError);
			javax.swing.JOptionPane.showMessageDialog(this,
				getString("msg.outofmem.text"), getString("msg.outofmem.title"),
				javax.swing.JOptionPane.ERROR_MESSAGE);
		}
	}
	...
	final static public int SAVEAS_IMAGETYPE_JPEG = 0;
	final static public int SAVEAS_IMAGETYPE_PNG = 1;

	/*final static public int SAVEAS_IMAGETYPE_PNG256 = 2;
	 final static public int SAVEAS_IMAGETYPE_PNG16 = 3;*/

	public void saveAs(String strOut, int iWidth, int iHeight, float fQuality, int iSaveType) throws Exception {
		int iX = 0;
		int iY = 0;
	...
	public void saveAs_SC(String strOut, int iCountX, int iCountY, float fQuality, int iSaveType) throws Exception {
		int iX = 0;
		int iY = 0;
		int iWidth = 0;
		int iHeight = 0;
	...
	private void SaveAs(String strOut, BufferedImage bimg, int x, int y, int iOf, int iMax, int iSaveType, float fQuality) throws Exception {
		switch (iSaveType) {
		case SAVEAS_IMAGETYPE_JPEG: 
			{
				...
				com.sun.image.codec.jpeg.JPEGEncodeParam jpegEncodeParam =
					JPEGCodec.getDefaultJPEGEncodeParam(bimg);
		...
		case SAVEAS_IMAGETYPE_PNG: 
			{
				...
				try {
					...
					throw new Exception(
							"Für PNG Ausgabe wird das JAI (Java Advanced Imaging) " +
	...
	public synchronized static Map getDefaultTranslations() {
		if(defaultTranslations == null) {
			...
			defaultTranslations.put("msg.outofmem.text" , "There was not enough memory to save the image. Try to save the image in smaller pieces.");
