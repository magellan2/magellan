 ...
 * Providing copy ID and copy ID+name.
 */
public class UnitContainerContextMenu extends JPopupMenu{
	...
	private void initMenu() {
		...
		if (uc instanceof Ship) {
			...
			planShipRoute.addActionListener(
											new ActionListener() {
												public void actionPerformed(ActionEvent e) {
													planShipRoute();
												}
			...
			factionStats.addActionListener(
										   new ActionListener() {
											   public void actionPerformed(ActionEvent e) {
												   factionStats();
											   }
	...
	private void factionStats() {
		FactionStatsDialog d = new FactionStatsDialog(JOptionPane.getFrameForComponent(this), 
													  false, dispatcher, data, settings, (Faction)uc);
		d.setVisible(true);
	}
