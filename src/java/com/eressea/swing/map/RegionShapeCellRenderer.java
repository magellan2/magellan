	...
	implements Initializable, ContextChangeable, GameDataListener
{
	...
	protected void initDefaultRegionTypeColors() {
		...
		regionColors.put(StringID.create("W?üste"), new Color(244, 230, 113));
																  ...
																  ActionListener
	{
		private class ModePanel extends JPanel implements ActionListener {
			...
			private class ListElementFactionTrustComparator implements Comparator {
				 ...
				 */
				public int compare(Object o1, Object o2) {
					String name1 = ((ListElement) o1).name;
					String name2 = ((ListElement) o2).name;
			 ...
			 *
			 * @param politics TODO: DOCUMENT ME!
			 */
