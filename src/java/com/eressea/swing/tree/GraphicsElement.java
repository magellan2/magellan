...
public class GraphicsElement {
	...
	/**
	 * Holds an icon if provided. Will be asked for at first from
	 * renderer.
	 */
	private Icon icon=null;

	/**
	 * Stores an image to create an icon from. Is asked secondly
	 * if no icon is provided.
	 */
	private Image image=null;

	/**
	 * A name for the image that could be used for an Image icon.
	 * Will be used by the renderer if neither icon nor image are
	 * provided.
	 */
	...
	// Text display things
	/**
	 * The object that should be displayed. If not null, the text
	 * of toString() will be used.
	 */
