 ...
 * (usually an eressea order). In Addition the user is asked,
 * if the order shall extend or replace existing orders.
 */
...
public class GiveOrderDialog extends InternationalizedDialog {
	...
	public GiveOrderDialog(Frame owner) {
		...
		GridBagConstraints c = new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.BOTH, new Insets(3, 3, 3, 3), 0, 0);
	...
	/**
	 * Shows the dialog and returns a String-Array with to values:
