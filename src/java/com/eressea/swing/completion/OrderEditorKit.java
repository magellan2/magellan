 ...
 *  I (Ilja Pavkovic) personally dislike the way &lt;CTRL&gt;-&lt;Right&gt; and
 *  &lt;CTRL&gt;-&lt;Left;gt; is handled. 
...
public class OrderEditorKit extends StyledEditorKit {
	...
	/**
	 * Fetches the order list for the editor.  This is
	 * the list of orders supported by the superclass
	 * augmented by the collection of orders defined
