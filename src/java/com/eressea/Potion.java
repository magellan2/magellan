...
/**
 * Container class for a potion based on its representation in a
 * cr version >= 42.
 */
public class Potion extends DescribedObject {
	...
	/**
	 * Returns the ingredients required for this potion. The elements
	 * are instances of class Item.
	 */
	...
	/**
	 * Puts a new element into the list of ingredients required to
	 * brew this potion.
	 */
	...
	/**
	 * Removes an item from the list of ingredients required to brew
	 * this potion.
	 *
	...
	/**
	 * Indicates whether this Potion object is equal to another
	 * object. Returns true only if o is not null and an instance of
	 * class Potion and o's id is equal to the id of this 
	 * Potion object.
	 */
	...
	/**
	 * Imposes a natural ordering on Potion objects equivalent to
