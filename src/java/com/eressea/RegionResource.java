 ...
 *
 * The id of RegionResource objects is numerical and does not change
 * between reports of different turns, it can therefore be used for
 * merging reports.
 * In order to access a resource in a region this id proves unuseful,
 * though. Instead, the id of the resource's type makes more sense as
 * it also satisfies the uniqueness condition within a region.
 */
public class RegionResource implements Unique {
	...
	/**
	 * Constructs a new region resource with the specified id and
	 * type. There is no default constructor in order to enforce a
	 * valid id and type set for every RegionResource object.
	 */
	...
	/**
	 * This method allows to set the id of this resource even after
	 * object creation. It should be use with care
	...
	/**
	 * Specifies the type of the resource. Semantically, only a small
	 * range of item types are valid for a resource (iron, trees, etc.)
	 * Note that the type may server as a hash object for this
	...
	/**
	 * Sets the minimum skill level that is required to access this
	 * resource.
	 */
	 ...
	 * based on the ID of this object
	 */
	...
	/**
	 * Returns a hash code value for the object based on the ID of
	 * this object.
	 */
	public int hashCode() {
		// pavkovic 2003.01.16: even if the id seems to be unique 
	 ...
	 */
	public static void merge(GameData curGD, RegionResource curRes, GameData newGD, RegionResource newRes, boolean sameTurn) {
