...
public class FrameTreeBuilder extends Object {
    ...
    public final static String[] DEFAULT={"SPLIT","COMPONENT","/SPLIT"};
    ...
    protected boolean buildPart(Iterator e,FrameTreeNode me,String splitDef) throws Exception
    {
        double percent=0;
        int orientation=0;
        String ppo=splitDef.substring(6);
        try{percent=Double.parseDouble(ppo.substring(0,ppo.indexOf(' ')));}
        catch(Exception exc) {percent=0.5;}
