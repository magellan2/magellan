...
/**
 * A class representing a combat spell set for a certain unit. It
 * links a unit with a certain spell and contains information at
 * which level the unit wants to cast the spell.
 */
public class CombatSpell extends Identifiable {
	...
	/**
	 * Retrieve the unit that has this combat spell set as a combat
	 * spell.
	 * 
	...
	/**
	 * Sets the unit which has this combat spell set as a combat
	 * spell.
	 * 
	 ...
	 *
	 * @param castingLevel this value must be greater than 0 and 
	 * not greater than the unit's magic skill level.
	 */
	...
	/**
	 * Indicates whether this CombatSpell object is equal to another
	 * object.
	 * 
	 * @param o the CombatSpell object to compare with.
	 * @return true only if o is not null and an instance of
	 * class CombatSpell and o's id is equal to the id of this 
	 * CombatSpell object.
	 */
	...
	/**
	 * Imposes a natural ordering on CombatSpell objects equivalent to
