...
/**
 * A class providing convience functions for handling directions like
 * in ships or borders.
 * There are three direction formats and the coversions between them
 * supported: integer representation (0 = north west and clockwise
 * up), string representation (like 'NW' or 'Nordwesten') and
...
public class Direction {
	...
	public final static int DIR_NW = 0;
	/** north east direction */
	public final static int DIR_NE = 1;
	/** east direction */
	public final static int DIR_E = 2;
	/** south east direction */
	public final static int DIR_SE = 3;
	/** south west direction */
	public final static int DIR_SW = 4;
	/** west direction */
	public final static int DIR_W = 5;
	...
	/**
	 * Creates a new Direction object interpreting the specified
	 * integer as a direction according to the direction constants of
	 * this class.
	 */
	...
	/**
	 * Creates a new Direction object interpreting the specified
	 * coordinate as a direction.
	 *
	 * @param c a relative coordinate, e.g. (1, 0) for DIR_E. If c is
	...
	/**
	 * Creates a new Direction object interpreting the specified
	 * String as a direction.
	 *
	 * @param str a german name for a direction, e.g. "Osten" for
	 * DIR_E. If str is null an IllegalArgumentException is thrown.
	...
	/**
	 * Returns a relative coordinate representing the direction dir.
	 * E.g. the direction DIR_W would create the coordinate (-1, 0).
	 */
	 ...
	 * Returns a String representation of the specified direction.
	 *
	 * @param short if true, a short form of the direction's string
	...
	/**
	 * Converts a relative coordinate to an integer representation of
	 * the direction.
	 */
	...
	/**
	 * Converts a string to an integer representation of
	 * the direction.
	 */
	...
	/**
	 * Returns the names of all valid directions in an all-lowercase
	 * short form.
	 */
	...
	/**
	 * Finds pattern in the set of matches (case-sensitively) and
	 * returns the index of the hit. Pattern may be an abbreviation
	 * of any of the matches. If pattern is ambiguous or cannot be
