...
public class BookmarkManager implements ShortcutListener, SelectionListener, GameDataListener {
	...
	/**
	 * Bookmarks the given Object o, if it has not already
	 * been bookmarked. In this case o is deleted from
	 * the bookmark list.
	 */
	...
	/**
	 * Differs from toggleBookmark in that way
	 * that it guarantees, that o is in the bookmark
	 * list after the call
	 */
