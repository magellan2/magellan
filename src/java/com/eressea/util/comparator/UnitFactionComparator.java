 ...
 * of equality. I.e. if the two compared units belong to the same faction
...
public class UnitFactionComparator implements Comparator {
	 ...
	 * @param factionComparator the comparator used to compare the
	 * units' factions.
	 * @param sameFactionSubComparator if two units belonging to the
	 * same faction are compared, this sub-comparator is applied if
	 * it is not <tt>null</tt>.
	 */
	public UnitFactionComparator (Comparator factionComparator, Comparator sameFactionSubComparator) {
