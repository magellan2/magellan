...
/**
 * A comparator imposing an ordering on MessageType objects by comparing the
 * sections (categories) they belong to.
 * 
 * <p>
 ...
 * I.e. if the two compared messages belong to the same section and they would
...
public class MessageTypeSectionComparator implements Comparator {
	 ...
	 *
	 * @param sameSectionSubComparator if two messages belonging to the same
	 * 		  section are compared, this sub-comparator is applied if it is
	 * 		  not <tt>null</tt>.
	 */
	...
	/**
	 * Compares its two arguments for order according to the sections they
	 * belong to.
	 *
	 * @param o1 TODO: DOCUMENT ME!
	 * @param o2 TODO: DOCUMENT ME!
	 *
	 * @return the result of the String.compareTo() method applied to
	 * 		   <tt>o1</tt>'s and <tt>o2</tt>. If both belong to the same
	 * 		   section and a sub-comparator was specified, the result that
	 * 		   sub-comparator's comparison is returned.
	 */
