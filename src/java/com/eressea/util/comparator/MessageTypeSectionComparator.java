...
/**
 * A comparator imposing an ordering on MessageType objects by comparing
 ...
 * of equality. I.e. if the two compared messages belong to the same section
...
public class MessageTypeSectionComparator implements Comparator {
	 ...
	 * @param sameSectionSubComparator if two messages belonging to the
	 * same section are compared, this sub-comparator is applied if
	...
	/**
	 * Compares its two arguments for order according to the sections
	 * they belong to.
	 * @returns the result of the String.compareTo() method applied to
