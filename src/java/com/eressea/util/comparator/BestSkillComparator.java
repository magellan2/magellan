 ...
 * by comparing the best skills available in each set.
...
public class BestSkillComparator implements Comparator {
	 ...
	 * @param bestComparator used to determine the best skill in each
	 ...
	 */
	public BestSkillComparator (Comparator bestComparator, Comparator skillComparator, Comparator subComparator) {
	 ...
	 * - according to the best comparator - smallest skills in o1 and
	 * o2.
	 */
