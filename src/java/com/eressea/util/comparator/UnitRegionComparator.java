 ...
 * the regions they are in.
 * <p>Note: this comparator can impose orderings that are inconsistent
 * with equals.</p>
 */
public class UnitRegionComparator implements Comparator {
	 ...
	 *
	 * @param regionSubComparator is used to compare the regions that
	 * two units to be compared belong to. If regionSubComparators
	 * regards the regions as equal, the comparator
	 * sameRegionSubComparator is applied.
	 * @param sameRegionSubComparator is applied if the
	 * regionSubComparator regards two units equal according to the
	 * regions they are in.
	 */
	...
	/**
	 * Compares its two arguments for order according to the regions
	 * they belong to.
	 * @returns the result of the region sub-comparator applied to
	 * the regions of the the two units o1 and o2 or the result of
	 * the sameRegion sub-comparator if the afore-said comparator
