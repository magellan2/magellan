...
/**
 * A comparator imposing an ordering on Unit objects by comparing the groups
 * they belong to.
 * 
 * <p>
 ...
 * I.e. if the two compared units belong to the same group or they have no
 * group set and they would be regarded as equal by this comparator, instead
 * of 0 the result of the sub-comparator's comparison is returned.
 * </p>
 */
public class UnitGroupComparator implements Comparator {
	 ...
	 * @param sameGroupSubComparator if two units belonging to the same group
	 * 		  are compared, this sub-comparator is applied if it is not
	 * 		  <tt>null</tt>.
	 * @param noGroupSubComparator if two units belonging to no group are
	 * 		  compared, this sub-comparator is applied if it is not
	 * 		  <tt>null</tt>.
	 */
	public UnitGroupComparator(Comparator groupComparator,
							   Comparator sameGroupSubComparator,
	 ...
	 * 		   returned. If both units do not belong to any group and a
	 * 		   no-group sub-comparator was specified, the result of that
