 ...
 * a class for holding statistic information about units and their skills like
 * number of persons with a specified skill or total skillpoints or things like that.
...
public class SkillStats {
	...
	/**
	 * returns a List containing the units with the specified skill
	...
	/**
	 * returns the number of persons that master the specified skill at exact that
	 * level, specified in the skill Object.
	 * That means, a call with a skill-Object containing let's say skilllevel 5,
	...
	/**
	 * returns the total number of persons that master the specified SkillType at any level
	 * (also level 0, as long as they have more than zero skillpoints of this skillType)
	 */
	...
	/**
	 * returns a sorted Collection containing the existing entries (type Skill) for the
	 * specified SkillType in the internal data. If type == null returns a Collection
	 * containing all existing entries (for all skilltypes)
	 */
