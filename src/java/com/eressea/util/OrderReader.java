...
public class OrderReader {
	...
	private void readFaction(ID id) throws IOException {
		...
		String naechsterOrder = Umlaut.normalize(Translations.getOrderTranslation(EresseaOrderConstants.O_NEXT,
																				  currentLocale));
		String localeOrder = Umlaut.normalize(Translations.getOrderTranslation(EresseaOrderConstants.O_LOCALE,
																			   currentLocale));
			...
			*/
			...
			if(naechsterOrder.startsWith(token)) {
				...
				if(tokenizer.hasMoreTokens()) {
					...
					naechsterOrder = Umlaut.normalize(Translations.getOrderTranslation(EresseaOrderConstants.O_NEXT,
																					   currentLocale));
	 ...
	 *
	 * @param autoConfirm TODO: DOCUMENT ME!
	 */
