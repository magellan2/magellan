...
public class Options implements com.eressea.util.EresseaOrderConstants {
	...
	public void initOptions() {
		...
		o = new EresseaOption(StringID.create(O_REPORT));
		o.setOrder(true);
		o.setBitMask(1 << 0);
		options.put(o.getID(), o);
		
		o = new EresseaOption(StringID.create(O_COMPUTER));
		o.setOrder(true);
		o.setBitMask(1 << 1);
		options.put(o.getID(), o);
		
		o = new EresseaOption(StringID.create(O_TEMPLATE));
		o.setOrder(true);
		o.setBitMask(1 << 2);
		options.put(o.getID(), o);
		
		o = new EresseaOption(StringID.create(O_SILVERPOOL));
		o.setOrder(true);
		o.setBitMask(1 << 3);
		options.put(o.getID(), o);
		
		o = new EresseaOption(StringID.create(O_STATISTICS));
		o.setOrder(true);
		o.setBitMask(1 << 4);
		options.put(o.getID(), o);
		...
		o = new EresseaOption(StringID.create(O_ZIPPED));
		o.setOrder(true);
		o.setBitMask(1 << 6);
		options.put(o.getID(), o);
		...
		o = new EresseaOption(StringID.create(O_ITEMPOOL));
		o.setOrder(true);
		o.setBitMask(1 << 8);
		options.put(o.getID(), o);
		
		o = new EresseaOption(StringID.create(O_ADDRESSES));
		o.setOrder(true);
		o.setBitMask(1 << 9);
		options.put(o.getID(), o);
		
		o = new EresseaOption(StringID.create(O_BZIP2));
		o.setOrder(true);
		o.setBitMask(1 << 10);
		options.put(o.getID(), o);
	...
	public String toString() {
		StringBuffer sb = new StringBuffer(com.eressea.util.Translations.getOrderTranslation(O_OPTION));
		for (Iterator iter = options.values().iterator(); iter.hasNext();) {
			EresseaOption o = (EresseaOption)iter.next();
