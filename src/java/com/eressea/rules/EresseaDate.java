...
public class EresseaDate extends Date {
	...
	public String toString(int iDateType) {
		...
		if(getEpoch() == 1) {
			...
			case TYPE_LONG:
				strDate = months_old[(iDate - 1) % 12] + " des Jahres " +
			...
			case Date.TYPE_LONG: {
				...
				default:
				case 0:
					strDate = week_long[iWeek] + strMonth + year_long + iYear +
							  age_long;

					break;

				case 1:
					strDate = week_long_alt[iWeek] + strMonth + year_long_alt +
							  iYear + age_long_alt;

					break;

				case 2:
					strDate = week_long_alt2[iWeek] + strMonth +
							  year_long_alt2 + iYear + age_long_alt2;
			...
			case TYPE_PHRASE: {
				...
				default:
				case 0:
					strDate = begin_phrase + week_phrase[iWeek] + strMonth +
							  year_phrase + iYear + age_phrase;

					break;

				case 1:
					strDate = begin_phrase_alt + week_phrase_alt[iWeek] +
							  strMonth + year_phrase_alt + iYear +
							  age_phrase_alt;
				...
				case 2:
					strDate = begin_phrase_alt2 + week_phrase_alt2[iWeek] +
							  strMonth + year_phrase_alt2 + iYear +
							  age_phrase_alt2;
			...
			case TYPE_PHRASE_AND_SEASON: {
				...
				case 0:
					strDate = begin_phrase + week_phrase[iWeek] + strMonth +
							  year_phrase + iYear + age_phrase + season;
