...
/**
 * A class used to uniquely identify such objects as regions, ships
 * or buildings by an integer. The representation of the integer 
 * depends on the system default defined in the IDBaseConverter class.
 */
public class EntityID extends IntegerID {
	
	/**
	 * Constructs a new entity id based on the specified integer
	 * object.
	 */
	...
	/**
	 * Constructs a new entity id based on a new Integer object
	...
	/**
	 * Constructs a new entity id parsing the specified string for an
	 * integer using the default radix of the IDBaseConverter class.
	 */
	...
	/**
	 * Constructs a new entity id parsing the specified string for an
	 * integer using the specified radix.
	 */
	...
	/**
	 * Returns a string representation of this id which depends on the
	 * output of the IDBaseConverter class.
	 */
	 ...
	 *
	 * @returns true, if o is an instance of class EntityID and the
	 * numerical values of this object and o match.
	 */
	...
	/**
	 * Imposes a natural ordering on EntityID objects which is based
	 * on the natural ordering of the integers they are constructed
	 * from.
	 */
