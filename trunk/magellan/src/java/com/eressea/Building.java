...
public class Building extends UnitContainer implements HasRegion {
	 ...
	 * Could depend on size, so don't put it into the UnitContType.
	 */
	private int cost = 0;
	...
	/**
	 * Sets the region this building is in. If this building already
	 * has a region set, this method takes care of removing it from
	 * that region.
	 * 
 ...
 /**
	 * Indicates whether this Building object is equal to another
	 * object.
	 * 
	 * @param o the Building object to compare with.
	 * @return true only if o is not null and an instance of
	 * class Building and o's id is equal to the id of this 
	 * Building object.
	 */
	...
	/**
	 * Imposes a natural ordering on Building objects equivalent to
	...
	/**
	 * Merges buildings. The new one get the name, comments etc. from the current one,
	 * effects etc. are added, not written over.
	 ...
	 */
	public static void merge(GameData curGD, Building curBuilding, GameData newGD, Building newBuilding) {
