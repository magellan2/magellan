...
public class SaveSelectionAction extends MenuAction implements SelectionListener, GameDataListener {
	private final static Logger log = Logger.getInstance(SaveSelectionAction.class);
	...
	public final static String DESCRIPTION = "Selections";
	public final static String EXTENSION   = "sel";
	...
	public void actionPerformed(java.awt.event.ActionEvent e) {
		...
		if (fc.showSaveDialog(client) == JFileChooser.APPROVE_OPTION) {
			try {
				...
				log.error(exc);
				JOptionPane.showMessageDialog(client, exc.toString(), Translations.getTranslation(this,"msg.filesave.error.title"), JOptionPane.ERROR_MESSAGE);
			}
		}
	}
