 ...
 * identifiability through strings.
 *
 * The strings used to establish the uniqueness of this id may differ
 * from the strings specified with the constructor of a StringID
 * object. I.e. although with String s1 and s2 s1.equals(s2) is false
 * (new StringID(s1)).equals(new StringID(s2)) may be true.
 * Two StringID objects are regarded as equal when s1 differs from s2
 * only in case or the umlaut expansion of s1 equals s2 (or vice
 * versa).
 */
public class StringID implements ID {
	 ...
	 * See the class description on how the specified string is used
	 ...
	 * For equality rules see the class description, of course o must
	 * be an instance of StringID.
	 */
	...
	/**
	 * Performs a lexicographical comparision between this object and
	 * another instance of class StringID.
	 */
