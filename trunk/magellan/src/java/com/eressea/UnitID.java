...
/**
 * A class for identifying unit objects through an integer. This class
 * makes equivalent assumptions about the representation of the
 * integer as the EntityID class. It also provides additional
 * convenience methods and knowledge about TEMP unit ids (which are
 * represented as negative integers).
 *
 */
public class UnitID extends EntityID {

	/**
	 * Constructs a new UnitID object based on an Integer object
	...
	/**
	 * Constructs a new UnitID object based on the specified
	 * Integer.
	 */
	...
	/**
	 * Constructs a new UnitID object by parsing the specified
	 * string for an integer in the default representation of class
	 * IDBaseConverter.
	 */
	...
	/**
	 * Returns a String representation of this UnitID. The radix of
	 * the output depends on the default set in the IDBaseConverter
	 * class. This method is not TEMP id aware, i.e. negative ids are
	 * returned as the string representation of the absolute value but
	 * without a 'TEMP' prefix.
	 */
	 ...
	 *
	 * @returns true, if o is an instance of UnitID and the integer
	 * values of this and the specfied object o are equal.
	 */
	...
	/**
	 * Imposes a natural ordering on UnitID objects based on the
	 * natural ordering of the absolute values of the underlying
	 * integers.
	 */
	...
	/**
	 * Returns the integer contained in the specified string with the
	 * specified radix. This method is TEMP id aware, i.e. the string
	 * "TEMP 909" would return an Integer object with the numerical
	 * value -909.
	 */
