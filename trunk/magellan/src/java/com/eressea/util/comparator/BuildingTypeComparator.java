...
/**
 * A comparator imposing an ordering on Building objects by comparing their
 * types.
 * 
 * <p>
 ...
 * I.e. if the two compared buildings have the same type and they would be
...
public class BuildingTypeComparator implements Comparator {
	 ...
	 *
	 * @param aSubCmp if two buildings having the same type are compared, this
	 ...
	 *
	 * @return the natural ordering of <tt>o1</tt>'s and <tt>o2</tt>'s types as
	 * 		   returned by BuildingType.compareTo(). If the types are equal
	 * 		   and a sub-comparator was specified, the result of that
	 * 		   sub-comparator's comparison is returned.
	 */
