...
/**
 * A comparator imposing an ordering on Skill objects by comparing the skill
 * level and days.
 * 
 * <p>
...
public class SkillComparator implements Comparator {
	...
	/**
	 * Compares its two arguments for order according to the skill levels and
	 * days.
	 *
	 * @param o1 TODO: DOCUMENT ME!
	 * @param o2 TODO: DOCUMENT ME!
	 *
	 * @return a number &lt; 0 if o1's level is larger than the one of o2 or if
	 * 		   both levels are equal and o1's days is larger than o2's. A
	 * 		   number &gt; 0 is returned if o2's level is larger than o1's or
	 * 		   if both levels are equal and o2's days is larger than o1's. 0
	...
	public int compare(Object o1, Object o2) {
		...
		if((s1.getLevel() != s2.getLevel()) ||
			   (s1.noSkillPoints() && s2.noSkillPoints())) {
