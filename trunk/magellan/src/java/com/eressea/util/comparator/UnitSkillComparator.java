...
public class UnitSkillComparator implements Comparator {
	 ...
	 * @param subComparator if two units do not possess skills or if
	 * the skills comparator regards them as equal, this
	 ...
	 * The learning days of the best skill of unit one is compared to
	 * those of the second unit.
	 * @returns a number &lt; 0 if o1's best skill is alphabetically less
	 * than o2's best skill. If both units have the same best skill
	 * these are compared using the standard skill comparator.
	 * If these two values are the same, the subcomparator is used
