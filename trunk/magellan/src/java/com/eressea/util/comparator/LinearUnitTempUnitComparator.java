 ...
 * sorting all temp units behind normal units.
 ...
 * of equality. I.e. if the two compared units are either both normal
 * units or both temp units, instead of 0 the result of the
...
public class LinearUnitTempUnitComparator implements Comparator {
	 ...
	 * @param unitSubComparator if two units are of the same type
	 * (standard or temp unit), this sub-comparator is applied if it
	 * is not <tt>null</tt>.
	 */
