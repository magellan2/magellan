...
/**
 * A comparator imposing an ordering on Potion objects by comparing
 * their levels.
 ...
 * of equality. I.e. if the two compared potions have the same level
 * and they would be regarded as equal by this comparator, instead of
 * 0 the result of the sub-comparator's comparison is returned.</p>
 */
public class PotionLevelComparator implements Comparator {
	 ...
	 * @param sameLevelSubComparator if two spells with the
	 * same level are compared, this sub-comparator is applied if
	 ...
	 *  numerical level value. If they are equal and a sub-comparator
	 *  was specified, the result that sub-comparator's comparison is
	 *  returned.
	 */
