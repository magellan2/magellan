...
/**
 * A comparator imposing an ordering on <tt>Faction</tt> objects by comparing
 * the trust levels.
 * 
 * <p>
 ...
 * I.e. if the two compared factions belong to the same trust level and they
 * would be regarded as equal by this comparator, instead of 0 the result of
...
public class FactionTrustComparator implements Comparator {
	 ...
	 *
	 * @param sameFactionSubComparator if two factions with the same trust
	 * 		  level are compared, this sub-comparator is applied if it is not
	 * 		  <tt>null</tt>.
	 */
	 ...
	 *
	 * @return the difference of <tt>o2</tt>'s and <tt>o1</tt>'s     trust
	 * 		   level values. If this is 0 and a sub-comparator is specified,
	...
	public int compare(Object o1, Object o2) {
		...
		return ((t1 == t2) && (sameTrustSubCmp != null))
			   ? sameTrustSubCmp.compare(o1, o2) : (t2 - t1);
	}
