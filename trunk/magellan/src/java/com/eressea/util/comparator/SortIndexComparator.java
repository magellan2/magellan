...
/**
 * A comparator imposing an ordering on objects implementing the Sorted
 * interface by comparing their sorting indices.
 * 
 * <p>
 ...
 * I.e. if the two compared objects have the same sorting index and they would
...
public class SortIndexComparator implements Comparator {
	 ...
	 *
	 * @param sameIndexSubComparator if two objects with the same sort index
	 * 		  are compared, the given sub-comparator is applied (if not
	 * 		  <tt>null</tt>).
	 */
	 ...
	 *
	 * @return the numerical difference of <tt>o1</tt>'s and <tt>o2</tt>'s sort
	 * 		   indices. If the sort indices are equal and a sub-comparator was
	 * 		   specified, the result of that sub-comparator's comparison is
	 * 		   returned.
	 */
	public int compare(Object o1, Object o2) {
		int retVal = ((Sorted) o1).getSortIndex() -
					 ((Sorted) o2).getSortIndex();
