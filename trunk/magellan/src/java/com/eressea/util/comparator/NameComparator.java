...
/**
 * A comparator imposing an ordering on named objects by comparing
 ...
 * of equality. I.e. if the two compared objects have the same name
...
public class NameComparator implements Comparator {
	 ...
	 * @param sameNameSubComparator if two objects with the
	 * same name are compared, this sub-comparator is applied if
	 ...
	 * @returns the lexical difference of <tt>o1</tt>'s and <tt>o2</tt>'s
	 * names as returned by String.compareTo(). If the names are
