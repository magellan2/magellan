...
public class StringIndexReplacer extends AbstractParameterSwitch{
	...
	public synchronized static Map getDefaultTranslations() {
		if(defaultTranslations == null) {
			...
			// FIXME(pavkovic)
			defaultTranslations.put("description.false" , "Pr\u00FCft, ob das zweite Argument(als String) im ersten(als String) vorkommt. Es wird Gro\u00DF-/Kleinschreibung beachtet.");
			defaultTranslations.put("description.true" , "Pr\u00FCft, ob das zweite Argument(als String) im ersten(als String) vorkommt. Gro\u00DF-/Kleinschreibung wird ignoriert.");
		}
