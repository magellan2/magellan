...
public class DefinitionMaker {
	...
	protected static Replacer createBranchReplacer(BranchReplacer branch, StringTokenizer st, ReplacerFactory factory, String unknown, ReplacerSystem env) {
	...
	protected static Replacer createSwitchBranchReplacer(BranchReplacer branch, StringTokenizer st, ReplacerFactory factory, String unknown, ReplacerSystem env) {
	...
	protected static Replacer createListReplacer(StringTokenizer st, ReplacerFactory factory, String unknown, ReplacerSystem env) {
	...
	protected static Replacer createReplacer(String token, StringTokenizer st, ReplacerFactory factory, String unknown, ReplacerSystem env) {
	...
	protected static Replacer createParameterReplacer(ParameterReplacer param, StringTokenizer st, ReplacerFactory factory, String unknown, ReplacerSystem env) {
