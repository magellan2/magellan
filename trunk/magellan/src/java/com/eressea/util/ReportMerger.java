...
//			report.data.placeOrigin(usedTranslation);
	...
	private CoordinateID getOneRegion_AR_RR_Translation(GameData data){
		/**
		 * Ansatz:
		 * Sind die Schemen g�nstig verteilt, reicht eine AR Region und ihre Schemen
		 ...
		 * (da sonst auch diese Region in den Schemen enthalten sein m�sste)
		 * Die endg�ltieg Region unter der AR-Region kann Ozean sein und muss daher
		 * nicht in den Schemen sichtbar sein.
		 * Daher wird zuerst ein Pool von m�glichen Regionen gebildet, indem 
	...
	private CoordinateID getOneRegion_processARRegion(GameData data,Region r){
		...
		// zweite bedingung: Randregionen von schemen (nicht ozean-Regionen...), die nicht selbst schemen sind, d�rfen nicht weniger als 3
	...
	/**
	 * L�scht die Regionen aus regionList, welche nicht von allen Regionen in 
	...
	/**
	 * L�scht die Regionen aus regionList, welche als Ozean deklariert
	 * sind
	 * @param regionen
	 * @return
	 */
