 ...
 */
public class Umlaut {
	private final static char[]   UMLAUTS    = { 'Ä',  'Ö',  'Ü',  'ä',  'ö',  'ü',  'ß' };
	private final static String[] EXPANSIONS = { "Ae", "Oe", "Ue", "ae", "oe", "ue", "ss" };

	private final static Map recodedStrings = CollectionFactory.createHashtable();
	...
	/**
	 * Search <tt>string</tt> for a character contained in
	 * <tt>keys[]</tt> and replace it with the corresponding
	 * string in <tt>values[]</tt>.
	 *
	 * @param string the string to recode.
	 * @param keys an array of chars to be replaced in
	 * 		<tt>string</tt>.
	 * @param values an array of the strings that are used as 
	 *		replacements for the corresponding char in 
	 *		<tt>keys</tt>.
	 * @return a string with all occurrences of an element of the
	 * 	<tt>keys</tt> array replaced by the corresponding
	 *	element in the <tt>values</tt> array.
	 */
	static public String recode(String string, char[] keys, String[] values) {
	 ...
	 * @return the uppercase version of <tt>str</tt> with all
	 *		umlauts expanded.
	 */
