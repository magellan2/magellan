 ...
 * Well-known local directories and/or contents of the executed jar
 * file are used as fall-back resourcePaths.
 */
public class ResourcePathClassLoader extends ClassLoader {
	private final static Logger log = Logger.getInstance(ResourcePathClassLoader.class);
	...
	/**
	 * Creates a new class loader initializing itself with the
	 * specified settings.
	 */
	...
	/**
	 * Tells this loader which resource paths to search for classes
	 * and resources.
	 */
	...
	/**
	 * Returns the resource paths the static methods of this class
	 * operate on.
	 * 
	...
	/**
	 * Tells this loader which resource paths to search for classes
	 * and resources when operating statically.
	 */
	...
	/**
	 * Finds the resource with the given name in the given resource
	 * paths.
	 *
	 * @param  name the resource name
	 * @param resourcePaths additional resource paths to find the
	 * resource in
	 * @return a URL for reading the resource, or <code>null</code>
	 *		 if the resource could not be found
	 */
	...
	/**
	 * Searches the available resource paths for a resource with the
	 * specified name and returns the first match.
	 */
	...
	/**
	 * Searches the available resource paths for all resources with
	 * the specified name.
	 */
	...
	/**
	 * Searches the available resource paths for the resources with
	 * the specified names until at least one is found.
	 */
	...
	/**
	 * Searches the current directory for a resource with the
	 * specified name.
	 */
	...
	/**
	 * Searches the current directory for the resources with the
	 * specified names.
	 */
	...
	/**
	 * Checks if the object specified by the base location and the
	 * name exists. If it does, a valid URL pointing to is returned
	 * else null.
	 */
	...
	/**
	 * Tries to find the specified bunch of resources. As soon as one
	 * of the resources is found in a location no other location is
	 * searched but it is attempted to find as many of the other
	...
	/**
	 * Tries to find the specified bunch of resources. As soon as one
	 * of the resources is found in a location no further locations
	 * are scanned for the resources, but it is attempted to find as
	 * many of the other specified resources in the same location.
	 *
	 * @param names the resource names
	 * @return the URLs the found resources can be read from
	 */
	...
	/**
	 * Tries to find the given resource in all resource paths including
	 * working directory and source jar. It will return all found URLs.
	 */
