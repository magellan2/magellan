 ...
 * 
 * Sell-Mode: Shows the luxury sold in the region(first char) and the trade value
 * Price-Mode: Shows the price of a luxury.
 *
 * @author  Andreas
 * @version 1.0
 */
public class TradeTextCellRenderer extends TextCellRenderer implements GameDataListener, ActionListener, ContextChangeable {
	...
	protected final static String KEY = "LUXURY";
